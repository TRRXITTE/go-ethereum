...
func CommitGenesisState(db ethdb.Database, hash common.Hash) error {
    ...
    if len(blob) != 0 {
        ...
        case common.HexToHash("0xe5175d0427e765d3333648f98e72c1439d633100ef7d3558eb517a59023f41ea"):
            genesis = DefaultCustomPoWGenesisBlock()
        }
        if genesis != nil {
            alloc = genesis.Alloc
        } else {
...
func (g *Genesis) configOrDefault(ghash common.Hash) *params.ChainConfig {
    ...
    case ghash == common.HexToHash("0xe5175d0427e765d3333648f98e72c1439d633100ef7d3558eb517a59023f41ea"):
        return DefaultCustomPoWGenesisBlock().Config
    default:
